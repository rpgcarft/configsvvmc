...
<div class="col-sm-8">
<!--<span style="font-family: nexa;font-size: 50px;color: #fff;"><i class="fa fa-fw fa-area-chart"></i>&nbsp;ระบบร้านค้า</span><hr class="style-six">-->
<div class="card">
<div class="card-body">
	...
	?>
        ...
        <div class="container">
            <div class="row">
				...
				{
                                    //include_once '_page/manageuser.php';
					echo "<h5 class='mb-2 text-center'><div class='alert alert-primary'><i class='fa fa-exclamation-triangle'></i>ระบบร้านค้าเลือกการตั้งค่า</div></h5>";
				}
                                  ?>
                        </div>
                    </div>
