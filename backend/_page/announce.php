<?php
			if(isset($_POST['btn_edit']))
			{
				...
				$sql_edit = 'UPDATE setting SET announce = "'.$edit_name_category_u.'"';
				$query_edit = $connect->query($sql_edit);

				if($query_edit)
				{
					//* ประกาศ
                                    $msg = 'แก้ไขเรียบร้อยแล้ว announce สำเร็จแล้ว';
                                        $alert = 'success';
                                        $msg_alert = 'สำเร็จ!';
					//* REFRESH
					...
					<div class="row">
						<div class="col-md-12 mb-3">
				            <label for="edit_name_category"></label>
                                            <input type="text" class="form-control" id="edit_name_category" name="edit_name_category" value="<?php echo $setting['announce']; ?>">
				        </div>
