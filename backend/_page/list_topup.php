			<table class="table table-default table-striped table-condenseds">
				...
				<tbody>
					<?php
						$sql_list_topup = 'SELECT * FROM activities WHERE (action = "TOPUP Truewallet" || action = "TOPUP TrueMoney") ORDER BY id ASC';
							...
							while($list_topup = $query_list_topup->fetch_assoc())
							{
								...
								echo '
									<tr>
										...
										<td class="text-center">'.$list_topup['topup_amount'].'</td>
