...
body
{
  <!---ตรงนี่สามารถแก้ได้นะ---> 
 background: url() no-repeat center center fixed; <!---แบ็คกาว---> 
...
///////
                ...
                <form class="form-horizontal form-panel" id="form" role="form" action="install.php?step=completed" method="post">
                  ...
                  <div class="form-group">
                    <label for="name_server" class=" control-label">ตั้งชื่อร้านค้า</label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="name_server" name="name_server" value="LOLIMCSHOP ระบบร้านค้ามายคราฟ" required="">
                    </div>
                  </div>
                  <div class="form-group">
                 ...
                 <hr>
                      ...
                      <button type="submit" class="btn btn-primary btn-lg btn-block btn-next"><i class="fa fa-arrow-right"></i> ขอบคุณที่ใช้บริการ <small>: เสร็จสิ้นการติดตั้ง</small></button>
                </form>

                        </div>
                <?php }elseif($_GET['step'] == "completed"){ ?>
                	<h3 class="page-header-sub fontsupermarket font24"><i class="fa fa-check"></i> ขอบคุณที่ใช้บริการ <small>เสร็จสิ้นการติดตั้ง</small></h3><hr>
	...
	<?php
		...
		<div class="text-center">
                    <a class="btn btn-success btn-lg btn-next" href="../index.php"><i class="fa fa-home"></i> หน้าร้านค้า</a><p></p>
			<a class="btn btn-info btn-lg  btn-next" href="../backend"><i class="fa fa-dashboard"></i> หลังร้านค้า</a>
		</div>

	<!--แก้ตรงนี้ได้นะ <div class="alert alert-danger text-center fontquark" style="margin-top:20px;font-size:24px;"></div> -->
...
background: -webkit-linear-gradient(to right,#00FF00	, #00FF00	 #00FF00	)!important;
...
<small style="font-size:14px;">System & Design By <a href="https://discord.gg/MBd7wJa" style="color: white;text-decoration: underline;">YAMIKO_SAN</a></small>
</div>-->
</td>
</tr>
</tbody>
