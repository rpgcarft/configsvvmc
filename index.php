...
<!--<br><a style="font-size: 100px;"><?php echo $setting['name_server'];?></a>-->
...
<script async="" src="https://cdn.jsdelivr.net/npm/@widgetbot/crate@3" defer="" type="text/javascript" class="js-httpscdnjsdelivrnetnpmwidgetbotcrate3">
            new Crate({
            shard: 'https://discordapp.com/widget?id=692746477113442324&theme=dark" width="250" height="450" allowtransparency="true" frameborder="0"'
                })
              </script>-->
...
<script src="https://cdn.jsdelivr.net/npm/@widgetbot/crate@3" async defer>
  const button = new Crate({
    server: '692746477113442324',
    channel: '692767776473088050',
  ...
  // Change position
  setInterval(() => {
    button.options.location = ['bottom', button.options.location[1] === 'left']
  }, 1000)
</script>
              <script src="https://cdn.jsdelivr.net/npm/@widgetbot/crate@3" async defer>
  ...
  crate.notify('มีข้อความเด้งมา')
  crate.notify('ยินต้อนรับเข้าสู่เซิฟเวอร์ LOLIMC.ML')
</script>
<!---------------------------------------------------------------------------------------------->
<widgetbot
    server="692746477113442324"
...
background: -webkit-linear-gradient(to right, #2f3133)!important;
background: linear-gradient(to right,  #2f3133)!important;
padding:8px;color: white; text-align:center;margin-top: 40px;">
      <br>
      <p><a class="pa" href="backend"><span style="font-size:18px;">ระบบหลังร้าน</span></a></p>


      <div style="background: #2f3133!important;
background: -webkit-linear-gradient(to right, #2f3133)!important;
background: linear-gradient(to right,  #2f3133)!important;
padding:8px;color: white; text-align:center;margin-top: 40px;">
<small style="font-size:15px;">Design & System By <a href=" https://discord.gg/MBd7wJa" style="color: white;text-decoration: underline;">YAMIKO_SAN</a>
